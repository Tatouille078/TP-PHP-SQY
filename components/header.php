...
<body class="w-full min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 montserrat-normal">
    ...
    <header class="h-32 w-full flex justify-between items-center bg-gradient-to-r from-sky-600 to-sky-800 px-24 text-white text-xl">
        ...
        <div class="relative group">
            <p class="cursor-pointer border-5 border-transparent bg-sky-700 group-hover:bg-sky-600 transition-all px-2 py-1 rounded-3xl group-hover:border-sky-200">Icone du user</p>
            <div class="absolute inset-0 top-10 h-0 group-hover:h-38 text-black bg-gradient-to-br from-zinc-50 to-zinc-300 border-0 group-hover:border-1 border-transparent group-hover:border-zinc-400 rounded-xl transition-all duration-300 overflow-y-hidden">
                <div class="relative m-4 h-0 group-hover:h-full text-end flex flex-col justify-start items-end gap-y-2 text-lg">
                    <p>Mon profil</p>
